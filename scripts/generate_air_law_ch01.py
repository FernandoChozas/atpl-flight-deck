#!/usr/bin/env python3
"""
Generator for 010 Air Law - Chapter 1 Study Materials
Generates both:
1. Complete English Study Markdown: resumenes/convocatoria_1/010_air_law/010_ch01_international_agreements.md
2. Vector-Sharp Study PDF: resumenes/convocatoria_1/010_air_law/010_ch01_international_agreements.pdf
Designed for EXCLUSIVE STUDY (comprehensive coverage of syllabus, articles, tables, and AviationExam traps).
"""
...
MD_PATH = "resumenes/convocatoria_1/010_air_law/010_ch01_international_agreements.md"
PDF_PATH = "resumenes/convocatoria_1/010_air_law/010_ch01_international_agreements.pdf"

def build_pdf():
    pdf = PDFBuilder("Air Law", "010", "Chapter 1: International Agreements & Organizations")

    # Banner
    pdf.add_title_banner("Air Law", 1, "International Agreements & ICAO", "21-52")

    # Section 1
    pdf.add_heading_1("1. The Chicago Convention (1944)")
    pdf.add_paragraph(
        "The Convention on International Civil Aviation was signed in Chicago on 7 December 1944 by 52 States. "
        "It entered into force on 4 April 1947 following ratification by 26 States. It established the fundamental "
        "legal principles and technical framework for modern civil aviation, officially creating the International "
    ...
    pdf.add_callout(
        ...
        "To ensure that international civil aviation develops in a safe, efficient, and orderly manner, and that "
    ...
    pdf.add_callout(
        "trap",
        "Scope of Application: Civil vs State Aircraft (Article 3)",
        "The Chicago Convention applies SOLELY to civil aircraft. It does NOT apply to State aircraft. "
        "Aircraft used in military, customs, and police services are deemed State aircraft. No State aircraft "
        "may fly over or land on the territory of another State without authorization by special agreement.",
        max_chars=86
    )

    # Key Articles Table
    pdf.add_heading_2("Key Articles of the Chicago Convention (EASA Exam Core)")
    articles_data = [
        ["Art. 1", "Sovereignty", "Every State has complete and exclusive sovereignty over airspace above territory."],
        ["Art. 2", "Territory", "Land areas and adjacent territorial waters under State sovereignty. Excludes High Seas."],
        ["Art. 3", "State Aircraft", "Applies ONLY to civil aircraft. Military, customs, police aircraft are excluded."],
        ["Art. 5", "Non-scheduled", "Right to overflight and non-traffic landing without prior permission."],
        ["Art. 6", "Scheduled Flights", "Requires special permission or authorization of the State flown over."],
        ["Art. 7", "Cabotage", "Right to refuse carriage of domestic revenue traffic to foreign aircraft."],
        ["Art. 8", "Pilotless Aircraft", "No pilotless aircraft (UAV/drone) may fly without special authorization."],
        ["Art. 9", "Prohibited Areas", "Permitted for military necessity/public safety; must apply non-discriminatorily."],
        ["Art. 10", "Customs Airports", "States may require aircraft crossing border to land at designated customs airport."],
        ["Art. 11", "Applicability", "Air regulations must apply equally to national and foreign aircraft."],
        ["Art. 12", "Rules of the Air", "Over the High Seas, ICAO Rules of the Air apply WITHOUT EXCEPTION."],
        ["Art. 16", "Search of Aircraft", "Right to inspect foreign aircraft upon landing/departure without delay."],
        ["Art. 24", "Customs Duty", "Fuel, oil, and parts on board aircraft are exempt from customs duty."],
        ["Art. 29", "Documents on Board", "C of R, C of A, Crew Licences, Journey Log, Radio Licence, Manifests."],
        ["Art. 32", "Crew Licences", "Crew must hold licences issued or validated by the State of Registry."],
        ["Art. 33", "Recognition", "Mandatory recognition of C of A and licences IF standards equal or exceed ICAO."],
        ["Art. 37", "Adoption of SARPs", "ICAO adopts Standards and Recommended Practices in Annexes."],
        ["Art. 38", "Differences", "Mandatory immediate notification to ICAO if domestic rules differ from a Standard."],
        ["Art. 83 bis", "Transfer of Duties", "Transfer of State of Registry functions to State of Operator (leases)."]
    ]
    pdf.add_table(
        ["Article", "Title / Concept", "Key Rule & Exam Specifics"],
        articles_data,
        col_widths=[52.0, 110.0, 343.0]
    )

    # Section 2: Freedoms of the Air
    pdf.add_heading_1("2. The Freedoms of the Air")
    pdf.add_paragraph(
        "Commercial and transit rights are granted via bilateral or multilateral air service agreements. "
        "The International Air Services Transit Agreement covers the two technical freedoms, while the "
        "International Air Transport Agreement covers the commercial freedoms.",
        max_chars=92
    )

    freedoms_data = [
        ["1st Freedom", "Technical", "Right to fly across foreign territory without landing (Overflight)."],
        ["2nd Freedom", "Technical", "Right to land in foreign territory for non-traffic purposes (Refueling/Tech)."],
        ["3rd Freedom", "Commercial", "Right to carry revenue traffic from Home Country to Foreign Country."],
        ["4th Freedom", "Commercial", "Right to carry revenue traffic from Foreign Country back to Home Country."],
        ["5th Freedom", "Commercial", "Right to carry traffic between two foreign States on a flight starting/ending at home."],
        ["6th Freedom", "Extended", "Carriage between two foreign States via a commercial stop in the Home Country."],
        ["7th Freedom", "Extended", "Carriage between two foreign States entirely outside the Home Country."],
        ["8th Freedom", "Cabotage", "Consecutive Cabotage: Domestic leg in foreign State continuing an intl flight."],
        ["9th Freedom", "Cabotage", "Stand-Alone Cabotage: Domestic flight operated entirely within a foreign State."]
    ]
    pdf.add_table(
        ["Freedom", "Type", "Operational Definition & Example"],
        freedoms_data,
    ...
    pdf.add_callout(
        "trap",
        "5th Freedom vs 6th Freedom Example",
        "5th Freedom: An airline of Country A flies Country A -> Country B -> Country C, and carries commercial "
        "passengers between B and C. 6th Freedom: An airline of Country A carries passengers between Country B "
        "and Country C, but routing through Country A (e.g. London -> Dubai -> Sydney operated by Emirates).",
        max_chars=86
    )

    # Section 3: ICAO Structure
    pdf.add_heading_1("3. Structure & Governance of ICAO")
    pdf.add_bullet("Headquarters", "Permanently located in Montreal, Quebec, Canada.")
    pdf.add_bullet("The Assembly", "Sovereign body comprising ALL Contracting States. Meets once every 3 years. Each State has 1 vote. Approves budget, elects Council members, examines work.")
    pdf.add_bullet("The Council", "Permanent governing executive body responsible to the Assembly. Composed of 36 Contracting States elected by the Assembly for a 3-year term. Adopts Annexes with a 2/3 majority vote.")
    pdf.add_bullet("Air Navigation Commission (ANC)", "Composed of 19 independent technical experts appointed by the Council. Recommends SARPs and amendments.")
    pdf.add_bullet("Regional Offices", "7 offices worldwide: Paris, Dakar, Cairo, Nairobi, Bangkok, Lima, and Mexico City.")

    pdf.add_heading_2("Legal Distinction: Standards vs Recommended Practices (SARPs)")
    pdf.add_bullet("Standard (SARP)", "Any specification recognized as NECESSARY for safety or regularity. Mandatory for Contracting States. If impossible to comply, notification of difference is compulsory under Article 38.")
    pdf.add_bullet("Recommended Practice", "Any specification recognized as DESIRABLE in the interest of safety, regularity, or efficiency. Contracting States endeavor to conform, but difference notification is not strictly mandatory.")
    pdf.add_bullet("PANS (Procedures for Air Navigation Services)", "Operating procedures too detailed for Annexes (e.g. PANS-OPS Doc 8168, PANS-ATM Doc 4444). Approved by the Council (not adopted as Annexes).")

    # Section 4: Master Table of the 19 Annexes
    pdf.add_heading_1("4. Master Reference: All 19 ICAO Annexes")
    annexes_data = [
        ["Annex 1", "Personnel Licensing", "Flight crew, ATCOs, maintenance engineers, medical classes."],
        ["Annex 2", "Rules of the Air", "General rules, visual flight rules (VFR), instrument rules (IFR)."],
        ["Annex 3", "Meteorological Service", "METAR, TAF, SIGMET, aerodrome forecasts, world area forecast."],
        ["Annex 4", "Aeronautical Charts", "Approach, departure, en-route charts, chart symbols."],
        ["Annex 5", "Units of Measurement", "SI units, non-SI alternatives (feet, knots, nautical miles)."],
        ["Annex 6", "Operation of Aircraft", "Part I (Commercial Air Transport), Part II (General Aviation), Part III (Helos)."],
        ["Annex 7", "Aircraft Nationality & Marks", "Registration letters, nationality symbols, display locations."],
        ["Annex 8", "Airworthiness of Aircraft", "Type certificates, continuing airworthiness, CofA standards."],
        ["Annex 9", "Facilitation", "Customs, immigration, clearance formalities, baggage transit."],
        ["Annex 10", "Aeronautical Telecommunications", "Vol I (Radio Aids), Vol II (Voice/Data), Vol III (Comms), Vol IV/V (Radar)."],
        ["Annex 11", "Air Traffic Services", "ATC Service, Flight Information (FIS), Alerting Service, Airspace."],
        ["Annex 12", "Search and Rescue (SAR)", "Establishment of SAR units, emergency phases (INCERFA, ALERFA, DETRESFA)."],
        ["Annex 13", "Aircraft Accident Investigation", "Investigation protocols; sole objective: prevention of future accidents."],
        ["Annex 14", "Aerodromes", "Vol I (Aerodrome Design & Operations, runways, lights), Vol II (Heliports)."],
        ["Annex 15", "Aeronautical Information (AIS)", "AIP, NOTAM, SNOWTAM, ASHTAM, AIC, pre-flight information."],
        ["Annex 16", "Environmental Protection", "Vol I (Aircraft Noise certification), Vol II (Engine emissions)."],
        ["Annex 17", "Security", "Safeguarding international civil aviation against unlawful interference."],
        ["Annex 18", "Safe Transport of Dangerous Goods", "Packing, labeling, loading, inspection, emergency procedures."],
        ["Annex 19", "Safety Management", "State Safety Programme (SSP), Safety Management Systems (SMS)."]
    ]
    pdf.add_table(
        ["Annex", "Official Title", "Scope & Exam Relevance"],
        annexes_data,
        col_widths=[60.0, 155.0, 290.0]
    )

    # Section 5: Supplementary International Conventions
    pdf.add_heading_1("5. Supplementary International Conventions")
    conventions_data = [
        ["Tokyo (1963)", "Offences on Board", "Jurisdiction of State of Registry. Full legal authority to Pilot-in-Command."],
        ["The Hague (1970)", "Unlawful Seizure", "Hijacking. Obligation to extradite or prosecute hijackers severely."],
        ["Montreal (1971)", "Sabotage & Violence", "Acts against flight safety, destruction of aircraft or nav facilities."],
        ["Rome (1933/52)", "Surface Damage", "Strict liability for damage caused by foreign aircraft to third parties on ground."],
        ["Warsaw (1929)", "Carrier Liability", "Original limits on air carrier liability for passenger death/injury and cargo."],
        ["Montreal (1999)", "Modernised Liability", "Replaced Warsaw. Two-tier liability system using SDRs (Special Drawing Rights)."]
    ]
    pdf.add_table(
        ["Convention", "Subject Matter", "Core Legal Principle"],
        conventions_data,
        col_widths=[85.0, 115.0, 305.0]
    )

    # Section 6: European Framework
    pdf.add_heading_1("6. European Aviation Regulatory Framework")
    pdf.add_bullet("EASA (European Union Aviation Safety Agency)", "Headquartered in Cologne, Germany. Established by Basic Regulation (EU) 2018/1139. Responsible for rulemaking, type certification, environmental protection, standardisation inspections.")
    pdf.add_bullet("EUROCONTROL", "Headquartered in Brussels, Belgium. European Organisation for the Safety of Air Navigation. Operates Network Manager (NMOC) for air traffic flow management and Central Route Charges Office (CRCO).")
    pdf.add_bullet("ECAC (European Civil Aviation Conference)", "Located in Paris. Consultative body promoting harmonization of European air transport.")

    # Section 7: Exam Traps & Flash Drill
    pdf.add_heading_1("7. AviationExam Traps & Rapid Knowledge Drill")
    pdf.add_callout(
        "trap",
        "Trap 1: Who adopts ICAO Annexes?",
        "The Council of ICAO adopts Annexes and amendments with a two-thirds majority vote. The Assembly meets "
        "only every 3 years and does NOT adopt individual Annex amendments.",
        max_chars=86
    )
    pdf.add_callout(
        "trap",
        "Trap 2: High Seas Jurisdiction",
        "Over the High Seas, ICAO Rules of the Air apply without exception. No State has sovereignty over the High Seas.",
        max_chars=86
    )
    pdf.add_callout(
        "trap",
        "Trap 3: State Aircraft Classification",
        "State aircraft = Military, Customs, Police. The presence or absence of weaponry does not change this status.",
        max_chars=86
    )
    pdf.add_callout(
        "trap",
        "Trap 4: PIC Authority in Tokyo Convention 1963",
        "The Pilot-in-Command may impose reasonable measures (including restraint) on any person committing or "
        "about to commit an offence jeopardizing safety. The PIC may disembark or deliver the offender to competent authorities.",
        max_chars=86
    )

    pdf.add_heading_2("10-Second Self-Test Drill")
    pdf.add_bullet("Q1", "Which ICAO Annex covers Aircraft Accident Investigation? -> Annex 13.")
    pdf.add_bullet("Q2", "How many Contracting States are on the ICAO Council and what is their term? -> 36 States, 3 years.")
    pdf.add_bullet("Q3", "Under which Article must a State notify differences to ICAO? -> Article 38.")
    pdf.add_bullet("Q4", "Carrying passengers between two foreign States on a route originating at home is which freedom? -> 5th Freedom.")
    pdf.add_bullet("Q5", "Which Convention established universal jurisdiction for aircraft hijacking? -> The Hague Convention (1970).")
    pdf.add_bullet("Q6", "Where is EASA headquartered? -> Cologne, Germany. (EUROCONTROL: Brussels; ICAO: Montreal).")

    pdf.compile_pdf(PDF_PATH)

def build_markdown():
    md_content = """# 010 Air Law | Chapter 1: International Agreements & Organizations
...
```mermaid
flowchart TD
    CC["Chicago Convention (7 Dec 1944)"] --> OACI["Establishes ICAO (HQ: Montreal)"]
    CC --> SOB["Article 1: Complete & Exclusive Sovereignty"]
    CC --> SA["Article 3: Civil Aircraft ONLY (State Aircraft Excluded)"]
    
    OACI --> AS["Assembly (All States, Meets Triennially)"]
    OACI --> CO["Council (36 States, Elected for 3 Years)"]
    OACI --> ANC["Air Navigation Commission (19 Technical Experts)"]
```
...
```mermaid
flowchart LR
    subgraph Technical["Technical Freedoms (Transit Agreement)"]
        F1["1st Freedom:<br>Overflight without landing"]
        F2["2nd Freedom:<br>Non-traffic technical stop (refuel/maintenance)"]
    end
    subgraph Commercial["Commercial Freedoms (Transport Agreement)"]
        F3["3rd Freedom:<br>Carry traffic from Home to Foreign State"]
        F4["4th Freedom:<br>Bring traffic from Foreign State to Home"]
        F5["5th Freedom:<br>Traffic between 2 Foreign States en-route"]
    end
```
...
| **6** | **Operation of Aircraft** | **Part I**: International Commercial Air Transport - Aeroplanes.<br>**Part II**: International General Aviation - Aeroplanes.<br>**Part III**: International Operations - Helicopters. Fuel policies, equipment requirements, operator responsibilities. |
...
| **10** | **Aeronautical Telecommunications** | **Vol I**: Radio Navigation Aids (VOR, DME, ILS, MLS).<br>**Vol II**: Communication Procedures (phraseology, message priority).<br>**Vol III**: Communication Systems (voice and data).<br>**Vol IV**: Surveillance and Collision Avoidance (SSR, Mode S, ACAS/TCAS).<br>**Vol V**: Aeronautical Radio Frequency Spectrum Utilization. |
...
| **14** | **Aerodromes** | **Vol I**: Aerodrome Design and Operations (runway physical characteristics, taxiways, markings, visual approach slope indicator systems PAPI/VASI, lighting, rescue and fire fighting RFFS categories).<br>**Vol II**: Heliports. |
...
| **16** | **Environmental Protection** | **Vol I**: Aircraft Noise (Chapters 2, 3, 4, 14 noise certification standards).<br>**Vol II**: Aircraft Engine Emissions.<br>**Vol III**: Aeroplane CO2 Emissions.<br>**Vol IV**: CORSIA (Carbon Offsetting and Reduction Scheme). |
...
| :---: | :--- | :--- |
| **Tokyo (1963)** | **Offences and Certain Other Acts Committed on Board Aircraft** | • Applies to offences committed on board while the aircraft is in flight (from take-off power application until landing roll finishes).<br>• Jurisdiction lies primarily with the **State of Registry**.<br>• **Pilot-in-Command Powers**: Full legal authority to impose reasonable measures (including restraint) on any person who has committed or is about to commit an act jeopardizing safety. PIC may disembark or deliver offender to authorities. Crew/passengers may assist PIC without liability. |
| **The Hague (1970)** | **Suppression of Unlawful Seizure of Aircraft** | • Addresses aircraft **hijacking** (*unlawful seizure*).<br>• Obligates Contracting States to make hijacking punishable by severe penalties.<br>• Establishes universal jurisdiction: State must either **extradite or prosecute** the offender without exception (*aut dedere aut judicare*). |
| **Montreal (1971)** | **Suppression of Unlawful Acts Against the Safety of Civil Aviation** | • Addresses acts of **sabotage** and violence against civil aircraft or air navigation facilities (e.g. bomb threats, destroying navigation equipment).<br>• Extended by the **Montreal Protocol 1988** to cover acts of violence at airports serving international civil aviation. |
| **Rome (1933 / 1952)** | **Damage Caused by Foreign Aircraft to Third Parties on the Surface** | • Strict liability on the operator for death, injury, or property damage on the ground caused by aircraft or objects falling from it.<br>• Right of victim to compensation without proving operator negligence, subject to liability limits. |
| **Warsaw (1929)** | **Unification of Certain Rules for International Carriage by Air** | • Original convention governing carrier liability for passenger injury, death, baggage delay, and cargo loss.<br>• Introduced passenger ticket and baggage check standards. Established liability caps. |
| **Montreal (1999)** | **Modernised Air Carrier Liability Convention** | • Replaced the Warsaw system.<br>• Introduced **two-tier liability** system based on **Special Drawing Rights (SDRs)** for passenger injury/death: 1st tier (strict liability up to ~128,821 SDRs), 2nd tier (unlimited liability unless carrier proves no fault).<br>• Standardized electronic ticketing. |
